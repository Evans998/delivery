        ...
        <section class="section section-restourant">
            <div class="container">
                ...
                <div class="block cards">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card">
                            <div class="card-img"><img src="img/rollugor.png" alt="Ролл угорь стандарт"></div>
                            <div class="card-main">
                                ...
                                <div class="product-desc">
                                    <button class="button button--primary">В корзину<img src="/img/shopping-cart-white.svg" alt="Корзина" class="logo-cart"></button>
