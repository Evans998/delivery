...
<header class="header">
    <div class="container block block__header">
        <a href="/" class="link-logo">
            <img src="{{ asset('img/logo.svg') }}" alt="Логотип" class="logo-img">
        </a>
        <input type="text" class="input header-input" placeholder="Адрес доставки">
        <div class="header-buttons header__buttons">
            <div class="admin">
                <a href="{{ route('restourant.create') }}" class="button button--secondary ">Добавить рестаран</a>
                <a href="{{ route('product.create') }}" class="button button--secondary button-rest">Добавить блюдо</a>
            </div>
            <!-- /.admin -->
            <button class="button button--primary">
                <img src="{{ asset('img/user.svg') }}" alt="Пользователь" class="logo-user">
                <span class="text-button">Войти</span>
            </button>
            <button class="button button--secondary" id="cart">
                <img src="{{ asset('img/shopping-cart.svg') }}" alt="Корзина" class="logo-cart">
...
<footer class="footer">
    <div class="container block block__footer">
        <div class="footer-block"><a href="/" class="link-logo-foot">
                <img src="{{ asset('/img/logo.svg') }}" alt="Логотип" class="logo-img"></a>
        ...
        <div class="social-block">
            <a href="https://www.instagram.com/" target="_blank">
                <img src="{{ asset('/img/group1.svg') }}" alt="Инстаграмм">
            </a>
            <a href="https://ru-ru.facebook.com/" target="_blank">
                <img src="{{ asset('/img/group2.svg') }}" alt="Фейсбук">
            </a>
            <a href="https://vk.com/" target="_blank">
                <img src="{{ asset('/img/group3.svg') }}" alt="Вконтакте">
            </a>
        </div>
    </div>
</footer>
